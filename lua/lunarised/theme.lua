...
local theme = {
	base = {
		Boolean = { fg = lunarised.orange },
		Character = { fg = lunarised.orange },
		Conditional = { fg = lunarised.yellow },
		...
		StatusLine = { fg = lunarised.fg, bg = lunarised.contrast },
		StatusLineNC = { fg = lunarised.text, bg = lunarised.disabled },
	...
	treesitter = {
		...
		TSPunctSpecial = { fg = lunarised.black },
