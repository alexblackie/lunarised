...
local base = {
	...
	DiffAdd = { fg = lunarised.blue, bg = lunarised.none, style = 'reverse' },
	...
	PreCondit = { fg = lunarised.blue },
	PreProc = { fg = lunarised.yellow },
	Question = { fg = lunarised.blue },
	QuickFixLine = { fg = lunarised.highlight },
	Repeat = { fg = lunarised.blue },
	...
	SpellLocal = { fg = lunarised.blue, bg = lunarised.none, style = 'undercurl' },
	...
	StorageClass = { fg = lunarised.blue },
	String = { fg = lunarised.blue, bg = lunarised.none },
	Structure = { fg = lunarised.red },
	TabLineFill = { fg = lunarised.fg },
	Tabline = { fg = lunarised.fg },
	TablineSel = { fg = lunarised.bg, bg = lunarised.accent },
	Tag = { fg = lunarised.cyan },
	Title = { fg = lunarised.grey, bg = lunarised.none, style = 'bold' },
	Todo = { fg = lunarised.cyan, bg = lunarised.none, style = 'bold' },
...
local treesitter = {
	...
	TSAttribute = { fg = lunarised.cyan },
	TSBoolean = base.Boolean,
	TSCharacter = base.Character,
	TSConditional = base.Conditional,
	TSConstBuiltin = { fg = lunarised.pink },
	TSConstMacro = { fg = lunarised.pink },
	...
	TSNamespace = { fg = lunarised.red },
	TSNone = { },
	TSNumber = base.Number,
	TSOperator = base.Operator,
	TSParameterReference= { fg = lunarised.blue },
	TSProperty = { fg = lunarised.fg },
	...
	TSStringRegex = { fg = lunarised.pink },
	TSSymbol = { fg = lunarised.blue },
	TSTag = base.Tag,
	TSTagDelimiter = base.Tag,
	TSText = { fg = lunarised.fg },
	TSTextReference = { fg = lunarised.red },
	TSTitle = base.Title,
	TSType = base.Type,
...
local plugins = {
	-- GitGutter
	GitGutterAdd = { fg = lunarised.blue, bg = lunarised.bg_alt },
	GitGutterChange = { fg = lunarised.purple, bg = lunarised.bg_alt },
	GitGutterDelete = { fg = lunarised.red, bg = lunarised.bg_alt },
